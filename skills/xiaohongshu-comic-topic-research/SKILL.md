...
3. Use the local OpenCLI browser workflow with the user's existing login state. Apply the visible filters for image posts, most liked, and unseen; apply “within one week” only for ongoing comics.
