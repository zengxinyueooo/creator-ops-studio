...
export const demoState: WorkspaceState = {
  ...
  references: [
    { id: 'ref-1', accountId: 'manga-account', comicId: 'comic-1', topicId: 'topic-1', topicIds: ['topic-1'], researchTaskId: 'research-1', matchedKeyword: '溯洄春时 最新话', discoveryRank: 1, title: '晏，你脸红啦？', author: '昨日雨', sourceUrl: 'https://www.xiaohongshu.com/', likes: 2260, collects: 0, comments: 0, capturedAt: '今天 10:12', insight: '互动动作和脸红反应形成明确情绪钩子。', body: '演示详情：围绕角色靠近后的害羞反应展开，正式采集时保存来源笔记原始正文。', publishedAt: '6 天前', imageCount: 6, hashtags: ['溯洄春时', '漫画'], detailCapturedAt: '今天 10:20', detailError: '', detailStatus: 'detailed', reviewStatus: 'kept' },
